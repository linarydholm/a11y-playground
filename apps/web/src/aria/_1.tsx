      ...
      <div className="max-w-2xl flex flex-col gap-4">
        <article>
          ...
          <div className="flex items-center justify-content gap-4">
            ...
            <button className="font-bold px-2 bg-gray-800 py-0 rounded-md w-fit">Add +</button>
          </div>
      ...
      <div className="max-w-2xl flex flex-col gap-4">
        ...
        <div className="max-w-2xl flex flex-col gap-4">
          <article>
            <div
              role="img"
              className="aspect-video max-w-[320px] mb-2 rounded-lg bg-gray-800 border-gray-600 border"
            />
            <div className="flex items-center justify-content gap-4">
              <h2 className="truncate flex-1">California Dream Sweater</h2>
              <button className="font-bold px-2 bg-gray-800 py-0 rounded-md w-fit">Add +</button>
