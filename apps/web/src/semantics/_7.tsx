        ...
        <div className={tw(box, 'flex-col gap-2 flex-1 border-gray-600')}>
          ...
          <div className={tw(box, 'flex-col gap-2')}>
            ...
            <div className="grid grid-cols-4 w-full gap-2">
              <div className={tw(box, 'col-span-1 border-red-300')}>Google Adsense</div>
              <div className={tw(box, 'flex-col gap-2 col-span-3 border-red-300')}>
                Blocks
                <div className={tw(box, 'border-yellow-300')}>Product</div>
                <div className={tw(box, 'border-yellow-300')}>USP's</div>
                <div className={tw(box, 'border-yellow-300')}>Product Reviews</div>
                <div className={tw(box, 'border-yellow-300')}>Related Products</div>
