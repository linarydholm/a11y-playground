    ...
    >
      ...
      <div className="max-w-2xl flex flex-col gap-4">
        ...
        <article className="max-w-2xl flex flex-col gap-4">
          <q>The sea is vast, and made up of a butt-load of H2O particles.</q>
          ...
          <hr className="w-full bg-gray-500 h-px" />
          <p>
            From: <ins className="text-red-500">1587 SEK</ins>{' '}
            <del className="line-through text-gray-400">1999 SEK</del>
          </p>
          <hr className="w-full bg-gray-500 h-px" />
          <p>
            From: <data value="1587">1587 SEK</data>
          </p>
          <hr className="w-full bg-gray-500 h-px" />
          ...
          <hr className="w-full bg-gray-500 h-px" />
          <h2>NoA Ignite Address (Stockholm)</h2>
