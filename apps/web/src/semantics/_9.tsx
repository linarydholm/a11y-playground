      ...
      <div className="max-w-2xl flex flex-col gap-4">
        <div className="border-white border p-2">
          ...
          <div className={tw(isOpen ? 'block' : 'hidden')}>
            Our cookies are delivered from our warehouse within 1-3 business days and are stored in
            vacuum-sealed packaging. Freshness guaranteed!
          </div>
        </div>
      </div>
      ...
      <div className="max-w-2xl flex flex-col gap-4">
        ...
        <div className="max-w-2xl flex flex-col gap-4">
          <details className="border-white border p-2">
            <summary className="custom bg-transparent text-start p-0">Cookie Policy</summary>
            Our cookies are delivered from our warehouse within 1-3 business days and are stored in
            vacuum-sealed packaging. Freshness guaranteed!
          </details>
        </div>
